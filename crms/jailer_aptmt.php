...
.center {
  text-align:center;
    ...
    {
    $jid=$_POST['jid'];
    $query="select * from jlr_appointment where id='$jid' ";
    ...
    $row=mysqli_fetch_array($result);
      if($result)
      {
          ...
          $query="INSERT INTO jailer(j_id, j_pass, location, j_mail, j_name) VALUES('$jid','$pass','$location','$mail','$jname')";
          $res=mysqli_query($conn,$query);
          $del="DELETE FROM jlr_appointment WHERE id='$jid' ";
          $i=mysqli_query($conn,$del);
          if($res)
          {
        ...
        echo "<script type='text/javascript'>alert('$msg');</script>";
            ...
            $msg="This jailer with same id is already existing";
            echo "<script type='text/javascript'>alert('$msg');</script>";
          }
      }
      else{
        $msg="Invalid Jailer id ";
        echo "<script type='text/javascript'>alert('$msg');</script>";
      }
  }
    }
    ...
    $query="select * from jlr_appointment  ";
    $result=mysqli_query($conn,$query);
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">            
      <li class="active"><a href="jailer_aptmt.php">Jailer Appointments</a></li>
    ...
    <form style="margin-top: 6%; margin-left: 40%;" method="post">
      <input type="text" name="jid" style="width: 250px; height: 30px; background-color:white;" placeholder="&nbsp Jailer id" id="crid" required="" onfocusout="f1()">
        <div>
 ...
 <table class="table table-bordered">
    <thead class="thead-dark" style="background-color: black; color: white;">
      <tr>
        <th scope="col" class="center">Jailer Name</th>
        <th scope="col" class="center">Jailer Mail</th>
        <th scope="col" class="center">Jail Location</th>      
        <th scope="col" class="center">Jailer ID</th>
      </tr>
    </thead>
    <?php
...
<td class="center"> <?php echo $r['j_name'] ?></td>
<td class="center"><?php echo $r['j_mail']; ?></td>
