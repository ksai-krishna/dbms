...
if(isset($_POST['s']))
{
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $result=mysqli_query($conn,"SELECT p_id,p_pass FROM police where p_id='$name' ");
...
<body>
    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
	    ...
	    <li><a href="regpol.php">Police Register</a></li>
        </ul>
    </div>
  </div>
 </nav>
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    ...
    <input type="text" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" size="5" placeholder="Enter Police id" required onfocusout="f1()">
     </div>
  <div class="form-group" style="width:30%">
