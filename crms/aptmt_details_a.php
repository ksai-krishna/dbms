...
<head>
  ...
  <link rel="icon" href="./icons/aprv.png">
<script>
...
<body>
  ...
  <div class="container">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active" ><a href="aptmt_details_a.php">Appointment Details</a></li>
      <li ><a href="appointment_status.php">View Appointments</a></li>
   ...
   ?>    
       <tbody style="background-color: white; color: black;">
         <tr>
           ...
           <td class="a" ><?php echo $rows['udov']; ?></td>
           <td class="a" ><?php echo $rows['gender']; ?></td>
         </tr>
          </tbody>
