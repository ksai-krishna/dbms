...
<script>
  ...
  text-align:center;
    ...
    if(!isset($_SESSION['x']))
        ...
        if($stat==$st)
        {
            header("location:aptmt_details_jd.php");
        }
...
<table class="table table-bordered">
       ...
       <thead class="thead-dark" style="background-color: black; color: white;">
         ...
         <th scope="col" class="center">Scheduled Time</th>
       ...
       <tbody style="background-color: white; color: black;">
         <tr>
           ...
           <td   style=" width:100px; height:100px"> <img src="upload/<?= $filename65 ?>" width="150px" height="120px" > </td> 
             <td  class="center" ><?php echo $rows['v_name']; ?></td>
           <td   class="center"><?php echo $rows['age']; ?></td>
           <td  class="center" ><?php echo $rows['mobile_number']; ?></td>
           <td  class="center" ><?php echo $rows['relation']; ?></td>
           <td  class="center" ><?php echo $rows['status']; ?></td>
           <td  class="center" ><?php echo $udov; ?></td>
           <td  class="center" ><?php echo $rows['dov']; ?></td>
           <td  class="center" ><?php echo $rows['gender']; ?></td>
         </tr>
          </tbody>
